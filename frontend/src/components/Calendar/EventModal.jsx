  ...
  return (
    <div className="modal-overlay">
      <div className="modal-content">
        ...
        <p>
          <strong>End:</strong> {new Date(eventDetails.end).toLocaleString()}
        </p>
        <p>
          <strong>Motive:</strong> {eventDetails.title}
        </p>
        <p>
          <strong>Facility:</strong> {eventDetails.facility}
        </p>

        <p>
          <strong>State:</strong> {eventDetails.state}
        </p>
        {(eventDetails.state==='Pending')&&(<div className="button-group">
